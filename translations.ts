export const translations = {
    en: {
        ...
        about: {
            ...
            experience: 'I have gained experience in event and tradeshows for automotive, pharma and various other branches. I have worked with clients like BMW, BMS, Gilead and many more. <br> I have a strong background in project management and digital strategy, which allows me to understand the needs of my clients and deliver results that exceed their expectations.',
            change: "I've decided to make a change and broaden my portfolio. That's why you see this website.<br> I'm combining project management with technical and web development skills to meet today's employer needs.",
        },
        skills: {
            heading: 'Skills',
        ...
        testimonials: {
            quotes: [
                {
                    text: 'Felix combines creative vision with technical execution. His solutions are thoughtful, fast, and reliable.',
                    author: 'Jonas Bergmann – UX Consultant'
                },
                {
                    text: 'Felix remains calm and solution-oriented in fast-paced projects. A true anchor with clear focus.',
                    author: 'Sophie Lange – Scrum Master'
                },
                {
                    text: 'Few people think as structured and creatively as Felix. A real asset to any team.',
                    author: 'Markus Keller – Creative Director'
                },
                {
                    text: 'Felix doesn’t just follow – he thinks ahead. Great ideas, clean code, and crystal-clear communication.',
                    author: 'Anna Weber – Senior Developer'
                },
                {
                    text: 'Frontend and teamwork are in Felix’s DNA. Empathetic, smart, goal-driven – a heartfelt recommendation.',
                    author: 'Laura Schneider – Product Manager'
                }
            ]
        },
        contact: {
...
As a service provider, we are responsible for our own content on these pages in accordance with § 7 Para.1 TMG under the general laws.`
    ...
    de: {
        hero: {
            ...
            name: 'Felix Blaser',
            roles: ['Projektmanager', 'Frontend-Entwickler', 'Digitalstratege'],
            cta: 'Lass uns sprechen!',
            scroller: 'hier lang',
        },
        about: {
            title: 'Über mich',
            intro: 'Hi, ich bin Felix und arbeite als Projektmanager, Frontend-Entwickler und digitaler Stratege in der schönsten Stadt der Welt, München. <br> Ich habe meine Karriere als Event-Manager begonnen und Projekte für die Automobil- und Pharmaindustrie geleitet.',
            experience: 'Ich habe Erfahrung in Events und Messen für die Automobil-, Pharma- und viele andere Branchen. Ich habe mit Kunden wie BMW, BMS, Gilead und vielen anderen zusammengearbeitet. <br> Ich habe einen starken Hintergrund im Projektmanagement und in der digitalen Strategie, was es mir ermöglicht, die Bedürfnisse meiner Kunden zu verstehen und Ergebnisse zu liefern, die ihre Erwartungen übertreffen.',
            change: 'Ich habe beschlossen mich zu verändern und mein Portfolio zu erweitern. Deshalb sehen Sie diese Website.<br> Ich kombiniere Projektmanagement mit technischen und Webentwicklungsfähigkeiten, um den heutigen Anforderungen der Arbeitgeber gerecht zu werden.'
        },
        skills: {
            heading: 'Skills',
